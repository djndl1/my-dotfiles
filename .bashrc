...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@Redmi8\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\n\$ '
else
...
function setproxy {
        export {http,https,ftp}_proxy=http://[::1]:1082
}

function setHKproxy {
        export {http,https,ftp}_proxy=http://djn:freebird@43.128.11.210:8888
}
...
. ~/setup_hardware_accel.sh

PATH="/data/data/com.termux/files/home/perl5/bin:${PATH}"; export PATH;
...
export ZTE='fd08:31a4:a5de:8f00:764a:a4ff:fed1:e351'
